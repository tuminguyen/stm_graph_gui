...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("STM-Graph GUIv1.0.0")
    ...
    def init_ui(self):
        ...
        self.hide_components([self.btnBrowseShapeFile, self.lineShapeFilePath, self.labelParams2, 
                              self.lineVoronoiCellSmallVal, self.lineVoronoiCellLargeVal, self.lineMomentum, 
                              self.labelMomentum, self.labelLrPatience, self.lineLrPatience])
